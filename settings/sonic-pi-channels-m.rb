...
##| live_loop :ch2 do
##|   note, velocity = sync "/midi:_m__midi_sonic_pi:*:2/note_on"
##|   play scale(:Eb2, :major_pentatonic, num_octaves: 3).choose, release: 0.4, amp: rand
##| end
...
live_loop :ch14 do
  ...
  sample :drum_bass_hard, amp: velocity / 127.0, attack: 0.025, decay: 0.03, sustain: 0.01, release: 0.02
end


live_loop :ch15 do
  note, velocity = sync "/midi:_m__midi_sonic_pi:*:15/note_on"
  sample :drum_cymbal_closed, amp: velocity / 127.0, attack: 0.025, decay: 0.1, sustain: 0.3, release: 0.03
end

live_loop :ch16 do
  note, velocity = sync "/midi:_m__midi_sonic_pi:*:16/note_on"
  sample :drum_snare_soft, amp: velocity / 127.0, attack: 0.025, decay: 0.1, sustain: 0.3, release: 0.03
end
